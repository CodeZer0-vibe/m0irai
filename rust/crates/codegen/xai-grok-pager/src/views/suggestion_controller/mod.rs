...
impl SuggestionController {
    pub fn new() -> Self {
        Self {
            ...
            tab_pending: None,
            enabled: suggestion_env_bool("GROK_SUGGESTIONS").unwrap_or(false),
            dropdown: CompletionDropdownState::default(),
            ai_enabled: suggestion_env_bool("GROK_SUGGESTIONS_AI").unwrap_or(false),
...
fn suggestion_env_bool(name: &str) -> Option<bool> {
    #[cfg(feature = "grok-runtime")]
    {
        xai_grok_config::env_bool(name)
    }
