...
- Your own repo doc already found a concrete Claude ACP operational hazard: operator Stop hooks can hang turns unless Claude ACP runs with a clean `CLAUDE_CONFIG_DIR`. See [2026-06-28-acp-turn-transport.md](C:/Users/<user>/VibeCoding/zer0-agent-ci/docs/architecture/2026-06-28-acp-turn-transport.md).
