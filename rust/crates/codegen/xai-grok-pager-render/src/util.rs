...
///
/// This is presentation infrastructure used by the image overlay, so it must
/// not pull the Grok service-tools crate into the room-runtime feature graph.
...
mod tests {
    ...
    #[test]
    fn format_bytes_matches_the_established_overlay_labels() {
