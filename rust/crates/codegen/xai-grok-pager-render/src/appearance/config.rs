...
#[cfg(feature = "grok-runtime")]
const DEFAULT_SHOW_TIMELINE: bool = UiConfig::SHOW_TIMELINE_DEFAULT;
#[cfg(not(feature = "grok-runtime"))]
const DEFAULT_SHOW_TIMELINE: bool = false;
...
impl From<RawAppearanceConfig> for AppearanceConfig {
    fn from(raw: RawAppearanceConfig) -> Self {
        Self {
            ...
            // Service builds preserve their config-backed default. The room
            // renderer has no service config and starts with this disabled.
